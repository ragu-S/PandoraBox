/*
 * The purpose of this program is to demonstrate algorithms that manipulate bit patterns of unsigned 
...
int main() {
  ...
  setBits(num, 12, value2); // Inserts value2 bit pattern into num's bit pattern fron 
                            // num's 12th bit position
